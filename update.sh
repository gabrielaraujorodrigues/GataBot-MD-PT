...
echo -e "${BOLD}${GREEN}Rescatando arquivo \"$DB_FILE\" y moviendo a \"$BOT_DIR\".${RESET}"
...
if [ -e "$HOME/$DB_FILE" ]; then
echo -e "${BOLD}${GREEN}He encontrado un arquivo \"$DB_FILE\" en \"$HOME\", lo moveré a \"$BOT_DIR\".${RESET}"
