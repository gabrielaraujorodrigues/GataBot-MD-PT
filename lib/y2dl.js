...
if (json.erro == true) reject(false)
...
if (json.erro) return reject(false)
// nsole.log(taskid)
...
if (json2.erro) return reject(false)
if (json2.status == 'finished') {
status = true
resolve(json2)
break
}
if (json2.status == 'erro') return reject(false)
}
})

export {bestFormat, getUrlDl}
