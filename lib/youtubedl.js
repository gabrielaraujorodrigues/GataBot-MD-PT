...
status: false,
code: 400,
erro: '¿Que es lo que descarga? ingresa en link idiota'
}
}
...
status: false,
code: 400,
erro: 'Ese link es invalido pon en link de un video de youtube valido idiotas 🗿'
}
}
...
status: false,
code: 400,
erro: `Formato ${format} no es valido para ${type} pero puedes elegir unos de estos: ${valid_fmt.join(', ')}`
}
}
...
status: false,
code: 400,
erro: 'Donde pito esta la ID del video? no puedo extraerlo hdp'
}
}
...
status: false,
code: 400,
erro: 'La duración del video es demasiado larga, amigo. El máximo es de 3 horas, no puedes superar eso, ¿entendido? 👍🏻'
}
}
...
status: false,
code: 429,
erro: `Limite de descargas diarias (${limit}) alcanzados, intente de novo mas tardes.`
}
}
...
status: false,
code: 400,
erro: 'El video no existe, idiota. No sé si fue removido o si YouTube lo restringió... no tengo idea 🤷🏻'
}
}
...
code: 500,
erro:
'Estoy exhausto, idiota... Ya intenté hacer la solicitud varias veces y sigue sin funcionar, así que dejaré la solicitud para más tarde, ¡hasta luego! 😂'
}
} catch (erro) {
return {
status: false,
