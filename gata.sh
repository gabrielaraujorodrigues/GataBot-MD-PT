...
erro=$(pkg install git -y 2>&1 >/dev/null)
echo -e "\033[0;31mErro: $erro\033[0m" 
echo -e "\033[0;34mNo se pudo instalar Git. Verifique su conexão a Internet e inténtelo de novo. Si el erro continúa, instale de forma manual!!\nIf the erro continues, install manually!!\033[0m" 
...
erro=$(pkg install nodejs -y 2>&1 >/dev/null)
echo -e "\033[0;31mErro: $erro\033[0m" 
echo -e "\033[0;34mNo se pudo instalar Node.js. Verifique su conexão a Internet e inténtelo de novo. Si el erro continúa, instale de forma manual!!\nIf the erro continues, install manually!!\033[0m" 
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/GataNina-Li/GataBot-MD\ncd GataBot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
erro=$(pkg install ffmpeg -y 2>&1 >/dev/null)
echo -e "\033[0;31mErro: $erro\033[0m" 
echo -e "\033[0;34mNo se pudo instalar FFmpeg. Verifique su conexão a Internet e inténtelo de novo. Si el erro continúa, instale de forma manual!!\nIf the erro continues, install manually!!\033[0m" 
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/GataNina-Li/GataBot-MD\ncd GataBot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
erro=$(pkg install imagemagick -y 2>&1 >/dev/null)
echo -e "\033[0;31mErro: $erro\033[0m" 
echo -e "\033[0;34mNo se pudo instalar ImageMagick. Verifique su conexão a Internet e inténtelo de novo. Si el erro continúa, instale de forma manual!!\nIf the erro continues, install manually!!\033[0m" 
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/GataNina-Li/GataBot-MD\ncd GataBot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
erro=$(npm install -g yarn 2>&1 >/dev/null)
echo -e "\033[0;31mErro: $erro\033[0m" 
echo -e "\033[0;34mNo se pudo instalar Yarn. Verifique su conexão a Internet e inténtelo de novo. Si el erro continúa, instale de forma manual!!\nIf the erro continues, install manually!!\033[0m" 
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/GataNina-Li/GataBot-MD\ncd GataBot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
if yarn install 2>&1 >/dev/null | grep -E -i -q '(command not found|unable to locate package|E: Could not get lock|debconf: delaying package configuration|Package not found|Failed to fetch|404 Not Found|Hash sum mismatch|503 Service Unavailable|504 Gateway Timeout|408 Request Timeout|Connection timed out|Temporary failure resolving)'; then
erro=$(yarn install 2>&1 >/dev/null)
echo -e "\033[0;31mErro: $erro\033[0m" 
echo -e "\033[0;34mNo se pudo instalar yarn. Verifique su conexão a Internet e inténtelo de novo. Si el erro continúa, instale de forma manual!!\nIf the erro continues, install manually!!\033[0m" 
else
...
erro=$(npm install 2>&1 >/dev/null)
echo -e "\033[0;31mErro: $erro\033[0m" 
echo -e "\033[0;34mNo se pudo instalar NPM. Verifique su conexão a Internet e inténtelo de novo. Si el erro continúa, instale de forma manual!!\nIf the erro continues, install manually!!\033[0m" 
else
...
menu() {
	#GataBot-MD
	echo -e "${v1} MENÚ DE CONFIGURAÇÃO"
	printf "\n"
