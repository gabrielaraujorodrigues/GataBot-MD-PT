...
# Aviso:
# Edita este arquivo localmente, NO en el repositorio.
...
echo -e "${BLUE}Commit realizado con mensagem:${RESET} ${GREEN}\"$commit_message\"${RESET}"
else
...
log "${RED}Erro al hacer push ${RESET}\n"
fi
