...
import { en as enDefault, es as esDefault, pt as ptDefault } from './lib/multi-language/_default.js'
import { ar, en, es, id, pt } from './lib/idiomas/total-idiomas.js'

// • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • •
// [PT] > Adicione o número que será Bot e os que serão proprietários.
...
//mude para false para Desativar a "auto-reconexão" de sub-bots
global.gataJadibts = true

// Mude para false para usar o Bot do mesmo número do Bot.
...
global.botNumberCode = '' //example: "+59309090909" — deixar vazio para digitar no terminal
global.confirmCode = '' // Não tocar nisto : Do not touch this line
// • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • •

// • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • •
// ❰❰ Multi Idioma Dinâmico : Linguagem Múltipla Dinâmica (MID-GB) ❱❱
// [PT] > Adicione um dos idiomas disponíveis para o Bot em "mid".
// [EN] > Adicionei um dos idiomas disponíveis para o Bot em "mid".

// ❰❰ IDIOMAS DISPONÍVEIS : IDIOMAS DISPONÍVEIS ❱❱
// Português 👉 pt
// Inglês 👉 en
global.lenguajeGB = pt
global.mid = ptDefault
global.version_language = '1.0 (MID-GB)'

// [PT] > Si "default_language" esta vacío, su idioma predeterminado será Português ou será usado o idioma que cada usuário selecionou no momento do cadastro.
// [EN] > Se "default_language" estiver vazio, seu idioma padrão será Português ou o idioma que cada usuário selecionou no momento do cadastro será usado.
// • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • •
...
// • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • •
// [PT] > Agregate a ti, colaboradores o ayudates, aparecerá en el comando de lista de contactos.
// [EN] > Adding yourself, collaborators or helpers will appear in the contact list command.
global.official = [
// Agregate si eres Proprietário
...
global.desc2 = '' // Add long description (90 caractres max) (Este parámetro se aplicará sólo si su whasapp no tiene descrição)
...
// • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • •
// [PT] > INFORMAÇÃO DE VERSIONES DEL BOT, POR FAVOR
