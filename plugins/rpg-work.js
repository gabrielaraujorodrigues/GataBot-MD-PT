...
throw `*Ya trabajaste, espere unos ${msToTime(time - new Date())} para volver a trabajar!!*`
...
'Cuidarte el grupo cuando los admin no estaba por eso ganas',
...
'Te secuestran y te llevan a un coliseo subterraneo donde luchaste contra monstruos con personas que nunca antes habias conocido. Ganas',
'Limpias la chimenea y encuentras',
'Desarrollas juegos para ganarte la vida y ganas',
'Por que este comando se llama trabajo? Ni siquiera estas haciendo nada relacionado con el trabajo. Sin embargo, ganas',
'Trabajaste en la oficina horas extras por',
'Trabajas como secuestrador de novias y ganas',
'Alguien vino y representa una obra de teatro. Por mirar te dieron',
'Compraste y vendiste articulos y Ganaste',
...
'Ves a alguien luchando por subir una caja a su auto, te apresuras a ayudarlo antes de que se lastime. Despues de ayudarlos, amablemente te dan',
'Desarrollas juegos para ganarte la vida y ganas',
'Ganas un concurso de comer chili picante. El premio es',
'Trabajas todo el dia en la empresa por',
'Ayudas a moderar el grupo de GataDios por',
'Diseñaste un logo para FG por',
'Moderaste el grupo cuando GataDios no estaba, el pago fue',
'Trabajaste lo mejor que pudo en una imprenta que estaba contratando y gana su bien merecido!',
'Trabajas como podador de arbustos para FG98 y ganas',
'La demanda de juegos para dispositivos moviles ha aumentado, por lo que creas un novo juego lleno de micro-transacciones. Con tu novo juego ganas un total de',
