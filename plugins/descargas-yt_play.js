...
console.erro('Erro al obtener el buffer', erro)
throw new Erro('Erro al obtener el buffer')
}
}
...
throw new Erro('No se pudo obtener informação del video desde Invidious')
}
}
...
if (m.isWABusiness) {
await conn.sendFile(m.chat, yt_play[0].thumbnail, 'erro.jpg', texto1 + `> Escriben: "audio" para descargar  en audios\n> escriben "video" para en video.`, m, null, fake)
} else {
...
console.erro("Erro al obtener el tamaño del arquivo", erro)
return 0
}}
