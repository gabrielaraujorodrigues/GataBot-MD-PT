...
${lenguajeGB.smsLisG()} ${isBotAdmin ? `https://chat.whatsapp.com/${(await conn.groupInviteCode(jid)) || 'Erro'}` : 'NO SOY ADMINISTRADOR'}\n\n`
}
m.reply(
...
${lenguajeGB.smsLisF()} ${isBotAdmin ? '✅' : '❌'}
${lenguajeGB.smsLisE()} ${totalParticipants}
${lenguajeGB.smsLisG()} ${isBotAdmin ? 'Erro' : 'NO SOY ADMINISTRADOR'}\n\n`
}
m.reply(
`${packname} ${lenguajeGB.smsLisA()}
${lenguajeGB.smsLisB()} ${totalGroups}\n\n${txt}`.trim()
