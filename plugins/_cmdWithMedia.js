import { areJidsSameUser, generateWAMessage, proto } from '@whiskeysockets/baileys'
...
forwardingScore: 200,
isForwarded: false,
externalAdReply: {showAdAttribution: false, title: gt, body: vs, mediaType: 2, sourceUrl: accountsgb, thumbnail: imagen1}
}
})
}
break
...
m.chat,
{location: {degreesLatitude: content.latitude, degreesLongitude: content.longitude, name: content.caption || ''}},
options
)
break
case 'contact':
...
console.erro(`Erro al procesar conteúdo: ${e}`)
}
return
}
