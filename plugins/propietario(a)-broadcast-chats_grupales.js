...
if (!text && !m.quoted) return m.reply(lenguajeGB.smsBCMensagem(usedPrefix, command))
let fkontak = {
...
let tempo = d.toLocaleString('es-CO', {hour: 'numeric', minute: 'numeric', second: 'numeric', hour12: true})
...
const id = groups[i]
const infoGP = lenguajeGB.smsChatGP2(readMS, dia, mes, año, fecha, tempo)
