...
resp = '*Este comando sólo puede ser ejecutado por un usuário que sea Sub-Bot*.'
return conn.sendMessage(m.chat, {text: resp}, {quoted: m})
}
} catch (e) {
resp = '*Hubo un erro al intentar apagar el Sub-Bot.*'
console.log('Erro al intentar apagar el Sub-Bot: ', e)
return conn.sendMessage(m.chat, {text: resp}, {quoted: m})
}
}
