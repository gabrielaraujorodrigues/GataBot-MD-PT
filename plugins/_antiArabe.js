...
if (
(user.banned && m.text.includes('PIEDRA')) ||
...
m.chat,
mid.mAviso +
`@${m.sender.split`@`[0]} ha sido banido, por orden de mi proprietária no pueden usar el bot.\n\nSOLO PUEDEN USAR LOS SEGUIRTE COMANDO:\n- /jadibot\n- /jadibot code\n- /estado\n\n⚠️ \`\`\`Serás Banido(a)\`\`\` ⚠️`,
m
)
return !1
}
