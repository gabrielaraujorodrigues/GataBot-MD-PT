...
if (chat.antiTraba && m.text.length > 4000) { //Cantidad máxima de caracteres aceptados en un mensagem//
...
}, 1000)} else if (!bot.restrict) return m.reply(`${lenguajeGB['smsSoloProprietário']()}`)
}
return !0
} 
