...
if (!m.quoted) return m.reply(`⚠️ Responde a un mensagem para ${command === 'pin' ? 'fijarlo' : 'desfijarlo'}.`)
try {
let messageKey = {remoteJid: m.chat, fromMe: m.quoted.fromMe, id: m.quoted.id, participant: m.quoted.sender}
