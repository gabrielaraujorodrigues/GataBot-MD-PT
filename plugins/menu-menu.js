...
descripcion: bot.restrict ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled',
contexto: 'Permisos para el Bot',
showPrefix: true
},
{
comando: (bot.antiCall ? 'off ' : 'on ') + 'antillamar , anticall',
descripcion: bot.antiCall ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled',
contexto: 'Evitar recibir llamadas en el Bot',
showPrefix: true
},
{
comando: (bot.temporal ? 'off ' : 'on ') + 'temporal',
descripcion: bot.temporal ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled',
contexto: 'Ingreso del Bot temporalmente en grupos',
showPrefix: true
},
{
comando: (bot.jadibotmd ? 'off ' : 'on ') + 'serbot , jadibot',
descripcion: bot.jadibotmd ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled',
contexto: 'Permitir o no Sub Bots en este Bot',
showPrefix: true
},
{
comando: (bot.antiSpam ? 'off ' : 'on ') + 'antispam',
descripcion: bot.antiSpam ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled',
contexto: 'Dar aviso por hacer Spam',
showPrefix: true
},
{
comando: (bot.antiSpam2 ? 'off ' : 'on ') + 'antispam2',
descripcion: bot.antiSpam2 ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled',
contexto: 'Omitir resultado de comandos consecutivos',
showPrefix: true
},
{
comando: (bot.antiPrivate ? 'off ' : 'on ') + 'antiprivado , antiprivate',
descripcion: bot.antiPrivate ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled',
contexto: 'Prohibe que este Bot sea usado en privado',
showPrefix: true
},
{
comando: (global.opts['self'] ? 'on ' : 'off ') + 'publico , public',
descripcion: global.opts['self'] ? '❌' + 'Desativado || Disabled' : '✅' + 'Ativado || Activated',
contexto: 'Permitir que todos usen el Bot',
showPrefix: true
},
{
comando: (global.opts['autoread'] ? 'off ' : 'on ') + 'autovisto , autoread',
descripcion: global.opts['autoread'] ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled',
contexto: 'Mensagems leídos automáticamente',
showPrefix: true
},
{
comando: (global.opts['gconly'] ? 'off ' : 'on ') + 'sologrupos , gconly',
descripcion: global.opts['gconly'] ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled',
contexto: 'Hacer que funcione sólo en grupos',
showPrefix: true
},
{
comando: (global.opts['pconly'] ? 'off ' : 'on ') + 'soloprivados , pconly',
descripcion: global.opts['pconly'] ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled',
contexto: 'Hacer que funcione sólo al privado',
showPrefix: true
},

{
comando: m.isGroup ? (chat.welcome ? 'off ' : 'on ') + 'boas-vindas , welcome' : false,
descripcion: m.isGroup ? (chat.welcome ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Establecer boas-vindas en grupos',
showPrefix: true
},
{
comando: m.isGroup ? (chat.detect ? 'off ' : 'on ') + 'avisos , detect' : false,
descripcion: m.isGroup ? (chat.detect ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Avisos importantes en grupos',
showPrefix: true
},
{
comando: m.isGroup ? (chat.autolevelup ? 'off ' : 'on ') + 'autonivel , autolevelup' : false,
descripcion: m.isGroup ? (chat.autolevelup ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Subir de nivel automáticamente',
showPrefix: true
},
{
comando: m.isGroup ? (chat.modoadmin ? 'off ' : 'on ') + 'modoadmin , modeadmin' : false,
descripcion: m.isGroup ? (chat.modoadmin ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
...
descripcion: m.isGroup ? (chat.stickers ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Stickers automáticos en chats',
showPrefix: true
},
{
comando: m.isGroup ? (chat.autosticker ? 'off ' : 'on ') + 'autosticker' : false,
descripcion: m.isGroup ? (chat.autosticker ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Multimedia a stickers automáticamente',
showPrefix: true
},
{
comando: m.isGroup ? (chat.reaction ? 'off ' : 'on ') + 'reacciones , reaction' : false,
descripcion: m.isGroup ? (chat.reaction ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Reaccionar a mensagems automáticamente',
showPrefix: true
},
{
comando: m.isGroup ? (chat.audios ? 'off ' : 'on ') + 'audios' : false,
descripcion: m.isGroup ? (chat.audios ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Audios automáticos en chats',
showPrefix: true
},
{
comando: m.isGroup ? (chat.modohorny ? 'off ' : 'on ') + 'modocaliente , modehorny' : false,
descripcion: m.isGroup ? (chat.modohorny ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Comandos con conteúdo para adultos',
showPrefix: true
},
{
comando: m.isGroup ? (chat.antitoxic ? 'off ' : 'on ') + 'antitoxicos , antitoxic' : false,
descripcion: m.isGroup ? (chat.antitoxic ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Sancionar/remover a usuários tóxicos',
showPrefix: true
},
{
comando: m.isGroup ? (chat.antiver ? 'off ' : 'on ') + 'antiver , antiviewonce' : false,
descripcion: m.isGroup ? (chat.antiver ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: ' No acultar mensagems de \"una sola vez\"',
showPrefix: true
},
{
comando: m.isGroup ? (chat.delete ? 'off ' : 'on ') + 'antiremover , antidelete' : false,
descripcion: m.isGroup ? (chat.delete ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Mostrar mensagems removidos',
showPrefix: true
},
{
comando: m.isGroup ? (chat.antifake ? 'off ' : 'on ') + 'antifalsos , antifake' : false,
descripcion: m.isGroup ? (chat.antifake ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Remover usuários falsos/extranjeros',
showPrefix: true
},
{
comando: m.isGroup ? (chat.antiTraba ? 'off ' : 'on ') + 'antitrabas , antilag' : false,
descripcion: m.isGroup ? (chat.antiTraba ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Enviar mensagem automático en caso de lag',
showPrefix: true
},
{
comando: m.isGroup ? (chat.simi ? 'off ' : 'on ') + 'simi' : false,
descripcion: m.isGroup ? (chat.simi ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'SimSimi responderá automáticamente',
showPrefix: true
},
{
comando: m.isGroup ? (chat.modoia ? 'off ' : 'on ') + 'ia' : false,
descripcion: m.isGroup ? (chat.modoia ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Inteligencia artificial automática',
showPrefix: true
},

{
comando: m.isGroup ? (chat.antilink ? 'off ' : 'on ') + 'antilink , antilink' : false,
descripcion: m.isGroup ? (chat.antilink ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Remover links de WhatsApp',
showPrefix: true
},
{
comando: m.isGroup ? (chat.antilink2 ? 'off ' : 'on ') + 'antilink2 , antilink2' : false,
descripcion: m.isGroup ? (chat.antilink2 ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Remover links que contenga \"https\"',
showPrefix: true
},
{
comando: m.isGroup ? (chat.antiTiktok ? 'off ' : 'on ') + 'antitiktok , antitk' : false,
descripcion: m.isGroup ? (chat.antiTiktok ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Remover links de TikTok',
showPrefix: true
},
{
comando: m.isGroup ? (chat.antiYoutube ? 'off ' : 'on ') + 'antiyoutube , antiyt' : false,
descripcion: m.isGroup ? (chat.antiYoutube ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Remover links de YouTube',
showPrefix: true
},
{
comando: m.isGroup ? (chat.antiTelegram ? 'off ' : 'on ') + 'antitelegram , antitg' : false,
descripcion: m.isGroup ? (chat.antiTelegram ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Remover links de Telegram',
showPrefix: true
},
{
comando: m.isGroup ? (chat.antiFacebook ? 'off ' : 'on ') + 'antifacebook , antifb' : false,
descripcion: m.isGroup ? (chat.antiFacebook ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Remover links de Facebook',
showPrefix: true
},
{
comando: m.isGroup ? (chat.antiInstagram ? 'off ' : 'on ') + 'antinstagram , antig' : false,
descripcion: m.isGroup ? (chat.antiInstagram ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Remover links de Instagram',
showPrefix: true
},
{
comando: m.isGroup ? (chat.antiTwitter ? 'off ' : 'on ') + 'antiX' : false,
descripcion: m.isGroup ? (chat.antiTwitter ? '✅ ' + 'Ativado || Activated' : '❌ ' + 'Desativado || Disabled') : false,
contexto: 'Remover links de X (Twitter)',
showPrefix: true
}
]
...
➺ ${user.premiumTime > 0 ? '✅ Eres usuário Premium' : '❌ *Establecer Premium:* _' + usedPrefix + 'pase premium_'}
...
*❰❰ Pasatempo(s) ❱❱* 
➺ ${user.pasatempo === 0 ? '*Sin Registro*' : user.pasatempo + '\n'}
...
${
  m.isGroup
    ? `_✅ ➤ Ativado_
_❌ ➤ Desativado_`
    : `Para ver la configuração completa sólo use: *${usedPrefix}on* o *${usedPrefix}off*`
}\n
...
// Função para formatear arrays de comandos
...
{comando: 'estado , status', descripcion: false, contexto: 'Informação de mí estado', showPrefix: true},
{comando: 'infogata , infobot', descripcion: false, contexto: 'Informação sobre el Bot', showPrefix: true},
{comando: 'instalarbot , installbot', descripcion: false, contexto: 'Informação y métodos de instalación', showPrefix: true},
{comando: 'criadora , owner', descripcion: false, contexto: 'Informação sobre mí Criadora', showPrefix: true},
{comando: 'velocidad , ping', descripcion: false, contexto: 'Verifica la velocidad de este Bot', showPrefix: true},
{comando: 'Bot', descripcion: false, contexto: 'Mensagem predeterminado del Bot', showPrefix: false},
...
{comando: 'bcbot', descripcion: false, contexto: 'Notificar a usuários Sub Bots', showPrefix: true}
]
const commandsReport = [{comando: 'reporte , report', descripcion: '[texto] || [text]', contexto: 'Reportar comandos con erroes', showPrefix: true}]
const commandsLink = [
{
comando: 'botemporal , addbot',
descripcion: '[link] [cantidad] || [link] [amount]',
...
{comando: 'listavip , listprem', descripcion: false, contexto: 'Usuários con tempo premium', showPrefix: true},
{comando: 'listapremium , listpremium', descripcion: false, contexto: 'Lista de usuários premium', showPrefix: true}
]
const commandsGames = [
...
{comando: 'topgays', descripcion: false, contexto: 'Clasificación de usuários Gays 🏳️‍🌈', showPrefix: true},
{comando: 'topotakus', descripcion: false, contexto: 'Clasificación de usuários Otakus 🎌', showPrefix: true},
{comando: 'toppajer@s', descripcion: false, contexto: 'Clasificación de usuários pajeros 🥵', showPrefix: true},
{comando: 'topintegrantes', descripcion: false, contexto: 'Mejores usuários 👑', showPrefix: true},
{comando: 'toplagrasa', descripcion: false, contexto: 'Usuários más grasosos XD', showPrefix: true},
...
{comando: 'acertijo', descripcion: false, contexto: 'Responde al mensagem del acertijo 👻', showPrefix: true},
{comando: 'cancion', descripcion: false, contexto: 'Adivina la canción 🎼', showPrefix: true},
{comando: 'trivia', descripcion: false, contexto: 'Preguntas con opções 💭', showPrefix: true},
...
{comando: 'ruleta', descripcion: false, contexto: 'Suerte inaguardeda 💫', showPrefix: true},
{comando: 'ahorcado', descripcion: false, contexto: 'Adivina la palabras antes de que el ahorcado te atrape 😱', showPrefix: true},
{comando: 'ruletadelban', descripcion: false, contexto: 'Elimina un usuário al azar, solo para admins ☠️', showPrefix: true}
]
const commandsAI = [
...
{comando: 'delchatgpt', descripcion: false, contexto: 'Remover historial de la IA', showPrefix: true},
...
{comando: 'geminimg', descripcion: '(imagen) + [texto] || (image) + [text]', contexto: 'Busca informação de una imagen', showPrefix: true},
