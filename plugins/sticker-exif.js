...
if (!args[0])
return m.reply(
`*⚠️ USAR DE LA PRÓXIMOS MANETA\nEXEMPLO:* ${usedPrefix}${command} packname | author\n*Ejemplo:* ${usedPrefix}${command} GataBot | GataDios`
)
...
m.reply(
`✅ Perfecto, hemos actualizado el *EXIF* de tus stickers, eso significa que cada sticker que vayas a crear tendrá tu personalizado\nPackname: ${packname}\nAuthor: ${author || ''}`
)
}
