...
if (!db.data.chats[m.chat].antitoxic && m.isGroup)
return conn.sendButton(m.chat, wm, lenguajeGB.smsAdveu1() + lenGB, null, [[lenguajeGB.smsEncender(), lenGB]], fkontak, m)
...
handler.tags = ['owner']
handler.command = /^(del|delete|remover|\-)advertir|quitar|warn(ing)?$/i
handler.group = true
handler.admin = true
