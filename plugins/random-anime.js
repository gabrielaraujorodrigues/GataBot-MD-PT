...
conn.sendFile(m.chat, haha, 'erro.jpg', `_${command}_`, m, null, fake)
...
conn.sendFile(m.chat, randomkpopx, 'erro.jpg', `_${command}_`, m, null, fake)
...
conn.sendFile(m.chat, ronaldo, 'erro.jpg', '_*Siiiuuuuuu*_', m, null, fake)
...
conn.sendFile(m.chat, img[0].url, 'erro.jpg', '🐱', m, null, fake)
...
conn.sendFile(m.chat, loli, 'erro.jpg', `_${command}_`, m, null, fake)
...
.catch(() => {
conn.reply(m.chat, 'Ocurrio un erro, vuelve a intentar, si el fallo continua avisar a mi criador', m)
})
} else {
conn.reply(
m.chat,
...
conn.sendFile(m.chat, url, 'erro.jpg', '💕💕💕💕', m, null, fake)
...
conn.sendFile(m.chat, res, 'erro.jpg', '💕💕💕💕', m, null, fake)
...
conn.sendFile(m.chat, meme, 'erro.jpg', '😂😆', m, null, fake)
...
conn.sendFile(m.chat, url, 'erro.jpg', '*🇦🇷 Messi*', m, null, fake)
...
conn.sendFile(m.chat, tee, 'erro.jpg', `*_Navidad 🧑‍🎄*`, m, null, fake);  
...
if (neko == '') throw 'Erro'
conn.sendFile(m.chat, neko, 'erro.jpg', 'Nyaww~ 🐾💗', m, null, fake)
...
conn.sendFile(m.chat, json.result.female, 'erro.jpg', '*𝘾𝙃𝙄𝘾𝘼 ✨*', m, null, fake)
//conn.sendButton(m.chat, '𝘾𝙃𝙄𝘾𝘼 ✨', wm, json.result.female, [['𝙎𝙄𝙂𝙐𝙄𝙀𝙉𝙏𝙀 | 𝙉𝙀𝙓𝙏 🆕', `/${command}`]], null, null, m)
conn.sendFile(m.chat, json.result.male, 'erro.jpg', '𝘾𝙃𝙄𝘾𝙊 ✨', m, null, fake)
...
conn.sendFile(m.chat, json.url, 'erro.jpg', '_*💖 A-ara ara sempai 💖*_', m, null, fake)
...
conn.sendFile(m.chat, url, 'erro.jpg', '🥵 ♥ PIES ♥  🥵', m, null, fake)
...
conn.sendFile(m.chat, res2, 'erro.jpg', `_${command}_`, m, null, fake)
...
conn.sendFile(m.chat, pp, 'erro.jpg', m, null, fake)
...
conn.sendFile(m.chat, pp, 'erro.jpg', '✨ *AQUÍ TIENE EL CLIMA EN ESPAÑOL*', m, null, fake)
...
conn.sendFile(m.chat, pp, 'erro.jpg', '✨ *HERE IS THE WEATHER IN ENGLISH*', m, null, fake)
...
conn.sendFile(m.chat, pp, 'erro.jpg', '✨ *AQUI ESTÁ O TEMPO EM PORTUGUÊS*', m, null, fake)
