...
let handler = (m) => m
handler.before = async function (m, {conn, isAdmin, isBotAdmin, isProprietário, isRProprietário}) {
if (!m.isGroup) return
if (isAdmin || isProprietário || m.fromMe || isRProprietário || !isBotAdmin) return
...
chat.delete = false
await conn.reply(m.chat, `${mid.mAviso + mid.mTiktok} *@${toUser}*`, null, {mentions: [aa]})
...
let wasDeleteActive = chat.delete
chat.delete = false
await conn.reply(m.chat, `${mid.mAviso + mid.mYoutube} *@${toUser}*`, null, {mentions: [aa]})
await new Promise((resolve) => setTimeout(resolve, 100))
await conn.sendMessage(m.chat, {delete: {remoteJid: m.chat, fromMe: false, id: bang, participant: delet}})
let remove = await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
if (remove[0].status === '404') return
...
let wasDeleteActive = chat.delete
chat.delete = false
await conn.reply(m.chat, `${mid.mAviso + mid.mTelegram} *@${toUser}*`, null, {mentions: [aa]})
await new Promise((resolve) => setTimeout(resolve, 100))
await conn.sendMessage(m.chat, {delete: {remoteJid: m.chat, fromMe: false, id: bang, participant: delet}})
let remove = await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
if (remove[0].status === '404') return
...
let wasDeleteActive = chat.delete
chat.delete = false
await conn.reply(m.chat, `${mid.mAviso + mid.mFacebook} *@${toUser}*`, null, {mentions: [aa]})
await new Promise((resolve) => setTimeout(resolve, 100))
await conn.sendMessage(m.chat, {delete: {remoteJid: m.chat, fromMe: false, id: bang, participant: delet}})
let remove = await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
if (remove[0].status === '404') return
...
let wasDeleteActive = chat.delete
chat.delete = false
await conn.reply(m.chat, `${mid.mAviso + mid.mInstagram} *@${toUser}*`, null, {mentions: [aa]})
await new Promise((resolve) => setTimeout(resolve, 100))
await conn.sendMessage(m.chat, {delete: {remoteJid: m.chat, fromMe: false, id: bang, participant: delet}})
let remove = await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
if (remove[0].status === '404') return
...
let wasDeleteActive = chat.delete
chat.delete = false
await conn.reply(m.chat, `${mid.mAviso + mid.mX} *@${toUser}*`, null, {mentions: [aa]})
await new Promise((resolve) => setTimeout(resolve, 100))
await conn.sendMessage(m.chat, {delete: {remoteJid: m.chat, fromMe: false, id: bang, participant: delet}})
let remove = await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
if (remove[0].status === '404') return
...
let wasDeleteActive = chat.delete
chat.delete = false
await conn.reply(m.chat, `${mid.mAviso + mid.mDiscord} *@${toUser}*`, null, {mentions: [aa]})
await new Promise((resolve) => setTimeout(resolve, 100))
await conn.sendMessage(m.chat, {delete: {remoteJid: m.chat, fromMe: false, id: bang, participant: delet}})
let remove = await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
if (remove[0].status === '404') return
...
let wasDeleteActive = chat.delete
chat.delete = false
await conn.reply(m.chat, `${mid.mAviso + mid.mThreads} *@${toUser}*`, null, {mentions: [aa]})
await new Promise((resolve) => setTimeout(resolve, 100))
await conn.sendMessage(m.chat, {delete: {remoteJid: m.chat, fromMe: false, id: bang, participant: delet}})
let remove = await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
if (remove[0].status === '404') return
...
let wasDeleteActive = chat.delete
chat.delete = false
await conn.reply(m.chat, `${mid.mAviso + mid.mTwitch} *@${toUser}*`, null, {mentions: [aa]})
await new Promise((resolve) => setTimeout(resolve, 100))
await conn.sendMessage(m.chat, {delete: {remoteJid: m.chat, fromMe: false, id: bang, participant: delet}})
let remove = await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
if (remove[0].status === '404') return
