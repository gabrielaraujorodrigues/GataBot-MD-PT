...
⊜ *Pasatempo(s)* ➺ ${user.pasatempo === 0 ? '*Sin Registro*' : user.pasatempo + '\n'}
⊜ *Experiencia ➟* ${exp} ⚡
⊜ *Diamantes ➟* ${limit} 💎
⊜ *GataCoins ➟* ${money} 🐈
...
{header: '📢 Grupos/Canales', title: '🔓 Para: Todos', description: '¡Te aguardemos!', id: usedPrefix + 'grupos'},
{
header: '🎁 Donar',
title: '🔓 Para: Todos',
...
let handler = async (m, { conn, usedPrefix, command, args, isProprietário, isAdmin, isRProprietário}) => {
try{
let locale = 'es'
let d = new Date(new Date + 3600000)
let time = d.toLocaleTimeString(locale, {
