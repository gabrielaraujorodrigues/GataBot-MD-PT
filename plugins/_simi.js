...
return m.reply(`${lol}`) /* EL TEXTO "lol" NO ESTA DEFINIDO PARA DAR ERRO Y USAR LA OTRA API */
await m.reply(res.data.message)
//await m.reply(data.success)
} catch {
/* SI DA ERRO USARA ESTA OTRA OPCION DE API DE IA QUE RECUERDA EL NOMBRE DE LA PERSONA */
