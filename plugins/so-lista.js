...
{regex: /(bem-vindo|bienvenid@)/gi, url: 'https://qu.ax/cUYg.mp3'},
...
{
regex:
/^(miarda de bot|mierda de bot|mearda de bot|Miarda de Bot|Mierda de Bot|Mearda de Bot|bot puto|Bot puto|Bot CTM|Bot ctm|bot CTM|bot ctm|bot pendejo|Bot pendejo|bot de mierda)$/i,
url: 'https://qu.ax/UEZQ.mp3'
},
{regex: /^(banido|Banido|baneada)$/i, url: 'https://qu.ax/SJJt.mp3'},
...
{
regex: /(Contexto|CONTEXTO|contexto|Pasen contexto|PASEN CONTEXTO|pasen contexto|Y el contexto|Y EL CONTEXTO|y el contexto)/gi,
url: 'https://qu.ax/YBzh.mp3'
},
...
{
regex:
/(Quién es tu senpai botsito 7u7|Quien es tu senpai botsito 7u7|Quién es tu sempai botsito 7u7|Quien es tu sempai botsito 7u7|Quién es tu senpai botsito 7w7|Quien es tu senpai botsito 7w7|quién es tu senpai botsito 7u7|quien es tu senpai botsito 7u7|Quién es tu sempai botsito 7w7|Quien es tu sempai botsito 7w7|Quién es tu senpai botsito|Quien es tu senpai botsito|Quién es tu sempai botsito|Quien es tu sempai botsito)/gi,
url: 'https://qu.ax/uyqQ.mp3'
},
...
{
regex: /(Cagaste|Miedo|miedo|Pvp|PVP|temor|que pasa|Que sucede|Que pasa|que sucede|Qué pasa|Qué sucede|Dime|dime)/gi,
url: 'https://qu.ax/FAVP.mp3'
},
...
{
regex: /(Estoy triste|ESTOY TRISTE|estoy triste|Triste|TRISTE|triste|Troste|TROSTE|troste|Truste|TRUSTE|truste)/gi,
url: 'https://qu.ax/QSyP.mp3'
},
...
this.sendMessage(m.chat, {audio: {url: matchedAudio.url}, fileName: 'erro.mp3', mimetype: 'audio/mp4', ptt: true}, {quoted: m})
} catch (e) {
console.erro(e)
} finally {
}
