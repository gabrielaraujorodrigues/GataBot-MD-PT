...
async function handler(m, { conn, command, text }) {
 ...
 //   console.log(analiztxt);
  ...
  //  if (!match || !match[1]) {
   //     return conn.sendMessage(m.sender, 'No se ha encontrado el número de cliente en el mensagem citado.');
   // }
  ...
  key: {
    ...
    id: "mensagem-1234567890" 
  },
  message: {
    conversation: "Mensagem personalizado"
  },
