...
👥 Consiste en usar el número del Bot para hablar con otras personas, es decir las dos personas estarán a la vez escribiendo por el chat privado del Bot, de esa manera ninguna 🔒de las dos personas pueden ver su número, Foto, usuário, descrição etc... 🔒

✨ Para poder hacer uso de esta função debes hacer lo siguiente:
...
✅ Si dejas ativado el #start tendrás más posibilidades de interactuar con la otra persona de forma Anónima 
...
❗ No nos hacemos responsables del mal uso que le puedas dar a esta função del Bot.`
