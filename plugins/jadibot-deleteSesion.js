...
El codigo de este arquivo fue realizado por:
...
console.erro(userS + ' ' + lenguajeGB.smsJBErr(), err)
}
}
}
}

handler.command = /^(deletesess?ion|removersesion|borrarsesion|delsess?ion|cerrarsesion)$/i
