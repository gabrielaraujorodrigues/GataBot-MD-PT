...
if (!sRes?.status || !Array.isArray(sRes?.data) || sRes.data.length === 0) throw new Erro('No se encontraron resultados para tu búsqueda.')
...
throw new Erro('No se pudo obtener el link de descarga.')
}
...
console.log('❌ Erro spotify-combinado:', e?.message || e)
m.react?.('❌')
m.reply('❌ Ocurrió un erro al procesar tu solicitud.')
}
}
